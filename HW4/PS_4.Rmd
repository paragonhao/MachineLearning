...
plot(x =2005:2014, ylim=c(-0.6,2),y = vwretd_cum_ret, main="Return Estimation Vs Actual Return 10 Year with different Alpha", type="l", col="blue", ylab="Return", xlab="Year")
for(i in 1:10){
...
plot(x =2005:2014, ylim=c(-0.6,2),y = vwretd_cum_ret, main="Return Estimation Vs Actual Return 1 Year with different Alpha", type="l", col="blue", ylab="Return", xlab="Year")
for(i in 1:10){
